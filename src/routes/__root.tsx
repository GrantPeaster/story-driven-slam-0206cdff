  ...
  head: () => ({
    meta: [
      ...
      { title: "Georgia Civil — Your Complete Project Partner" },
      {
        name: "description",
        content:
          "Stop carrying your development from firm to firm. Georgia Civil puts planners, surveyors, and civil engineers on the same team from day one.",
      },
      { name: "author", content: "Georgia Civil" },
      { property: "og:title", content: "Georgia Civil — Your Complete Project Partner" },
      {
        property: "og:description",
        content: "Integrated land planning, civil engineering, and surveying — one team, one process, no surprises.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500&family=Mulish:wght@300;400;500;600;700&family=Roboto:wght@400;500;700&display=swap",
      },
    ],
  }),
